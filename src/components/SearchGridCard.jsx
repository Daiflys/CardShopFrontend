...
const SearchGridCard = ({ card, onClick, formatPrice, getAvailableCount }) => {
  ...
  return (
    <div 
      className={`${isAvailable ? 'bg-white' : 'bg-gray-300'} rounded-lg border border-gray-200 hover:border-blue-300 transition-all cursor-pointer group hover:shadow-md overflow-hidden relative`}
      onClick={onClick}
    >
      {/* Card Image */}
      <div className={`aspect-[3/4] ${isAvailable ? 'bg-gray-50' : 'bg-gray-300'} rounded-t-lg p-2`}>
        {card.imageUrl ? (
          <img 
            src={card.imageUrl} 
      ...
      {/* Card Info */}
      <div className="p-4 relative min-h-[120px] flex flex-col">
        
        <div className="mb-3 flex-1">
          {/* Card name with language flag */}
          <div className="flex items-start gap-2 mb-2 relative">
            <h3 className="text-sm font-semibold text-black-900 flex-1 min-w-0 break-words leading-tight">
          ...
          <div className="flex items-center gap-2 text-xs text-black-400 mb-1">
          ...
          {isAvailable && hasNMStock ? (
            ...
            <>
              ...
              <div className="flex items-center justify-center gap-2 mb-3">
                ...
                <button
                  ...
                  className="w-8 h-8 border border-gray-300 rounded flex items-center justify-center hover:bg-gray-50 text-gray-600"
                >
                  −
                </button>
              ...
              <button
                ...
                className={`w-full py-2 px-3 rounded-md text-sm font-medium transition-colors flex items-center justify-center gap-2 ${
                  adding || loading 
            ...
            <>
              ...
              <button
                ...
                className="w-full py-2 px-3 bg-green-600 text-white rounded-md text-sm font-medium hover:bg-green-700 transition-colors"
              >
                Check Availability
              </button>
            </>
            ...
            <>
              ...
              <button
                ...
                className="w-full py-2 px-3 border border-red-400 text-red-600 rounded-md text-sm font-medium hover:bg-red-50 transition-colors flex items-center justify-center gap-2"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
