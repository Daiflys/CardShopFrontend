...
const SearchGridCard = ({ card, onClick, formatPrice, getAvailableCount }) => {
  ...
  return (
    <div
      className={`rounded-lg border border-gray-200 hover:border-blue-300 transition-all cursor-pointer group hover:shadow-md overflow-hidden relative w-full max-w-sm mx-auto ${
