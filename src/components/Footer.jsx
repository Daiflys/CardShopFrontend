...
const Footer = () => {
  ...
  return (
    <footer className={theme.components?.footer?.container || "bg-gray-900 text-white"}>
      <div className={theme.components?.footer?.content || "max-w-7xl mx-auto px-4 py-12"}>
        {/* Main Footer Content */}
        ...
        {/* Divider */}
        <div className={theme.components?.footer?.divider || "border-t border-gray-700 pt-8"}>

          {/* Logo Section - Centered */}
          <div className="flex justify-center mb-6">
            <div className={theme.components?.footer?.logoContainer || "text-gray-300"}>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            {/* Copyright */}
            <div className={theme.components?.footer?.copyright || "text-sm text-gray-400"}>
