        ...
        {isAdding ? (
          <>
            <span className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-white">
              <span className="h-3 w-3 rounded-full border-2 border-blue-700 border-t-transparent animate-spin" />
            </span>
            Adding...
          </>
        ) : isCardInCart ? (
          <>
            <span className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-white text-green-700">
          ...
          <>
            <span className="relative inline-flex h-5 w-5 items-center justify-center rounded-full bg-white text-blue-700">
              <svg className="h-3 w-3" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
              ...
              <span className="absolute -top-0.5 -right-0.5 h-3 w-3 rounded-full bg-blue-700 text-white flex items-center justify-center text-[9px] font-black leading-none">+
              </span>
            </span>
            Add to cart
          </>
