export const defaultTheme = {
  ...
  components: {
    header: {
      ...
      desktopContainer: "hidden lg:flex items-center justify-between px-4 sm:px-6 lg:px-8 py-4 w-full max-w-none",
      ...
      mobileButton: "block w-full px-4 py-3 border border-sky-300 rounded-md hover:bg-sky-50 text-sky-700 transition-colors text-center font-medium min-h-[44px] focus:outline-none focus:ring-2 focus:ring-sky-400 focus:ring-offset-2",
      mobileSignupButton: "block w-full px-4 py-3 bg-gradient-to-r from-sky-600 to-blue-600 text-white rounded-md hover:from-sky-700 hover:to-blue-700 transition-all shadow-md text-center font-medium min-h-[44px] focus:outline-none focus:ring-2 focus:ring-sky-400 focus:ring-offset-2",
